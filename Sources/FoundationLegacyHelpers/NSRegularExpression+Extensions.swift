// NSRegularExpression+Extensions.swift, 16.02.2020.
...
public extension NSRegularExpression {
	...
	func enumerateMatches(
		...
		options: NSRegularExpression.MatchingOptions = [],
		range: Range<String.Index>? = nil,
		using block: @escaping (NSTextCheckingResult?, NSRegularExpression.MatchingFlags, UnsafeMutablePointer<ObjCBool>) -> Void
	) {
		let range = range ?? string.startIndex ..< string.endIndex
	...
	@discardableResult func replaceMatches(
