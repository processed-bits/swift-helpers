// CGSize+Extensions.swift, 22.07.2021.
// Copyright © 2021-2025 Stanislav Lomachinskiy.
	...
	public extension CGSize {
		...
		init?(string: String, separator: String.Element = "x") {
			let stringComponents = string.split(separator: separator, maxSplits: 1, omittingEmptySubsequences: false).map(\.trimmed)
		...
		// MARK: Geometric Properties
			...
			/// The aspect ratio (width to height) of the size.
			@available(iOS 2.0, macOS 10.0, macCatalyst 13.0, tvOS 9.0, *)
