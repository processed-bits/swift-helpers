// exit.swift, 15.01.2023-12.03.2023.
...
///
/// When throwing errors, that should stop the program execution, the convenient way is to pass an error, that conforms to the ``ExitCodeProvidingError`` protocol, as an argument to the corresponding ``exit(_:)-5eps8`` helper function.
