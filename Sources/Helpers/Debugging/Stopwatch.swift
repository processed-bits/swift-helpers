// Stopwatch.swift, 15.04.2023-14.02.2025.
// Copyright © 2023-2025 Stanislav Lomachinskiy.
	...
	public class Stopwatch: CustomStringConvertible, CustomDebugStringConvertible, CustomReflectable {
		...
		public static let measurementFormatStyle: Measurement<UnitDuration>.FormatStyle = .measurement(
			width: .abbreviated,
		...
		public nonisolated(unsafe) static let measurementFormatter: MeasurementFormatter = {
