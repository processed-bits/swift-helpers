// CallsCounter.swift, 11.01.2021-12.02.2025.
// Copyright © 2021-2025 Stanislav Lomachinskiy.

/// Count the number or balance of calls (invocations) for debugging of code.
public class CallsCounter: @unchecked Sendable, CustomStringConvertible {

	/// Expected number of calls.
	public let expectedCount: Int?
	/// Actual count.
	@AtomicSerialized public private(set) var count: Int = 0
