// EventMonitor.swift, 26.03.2024-29.03.2024.
// Copyright © 2024 Stanislav Lomachinskiy. All rights reserved.

import AppKit

/// Event monitor is a wrapper for `NSEvent`'s app monitoring methods.
public final class EventMonitor {
	...
	public static func global(mask: NSEvent.EventTypeMask, handler block: @escaping (NSEvent) -> Void) -> Self {
	...
	public static func local(mask: NSEvent.EventTypeMask, handler block: @escaping (NSEvent) -> NSEvent?) -> Self {
