// NSMenuItem+Extensions.swift, 18.02.2023-06.03.2024.
// Copyright © 2023-2024 Stanislav Lomachinskiy.
	...
	public extension NSMenuItem {
		...
		convenience init(title string: String, target: AnyObject? = nil, action selector: Selector? = nil, keyEquivalent charCode: String = "", image: NSImage? = nil, tag: Int = 0, representedObject: Any? = nil) {
