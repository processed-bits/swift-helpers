// URL+Comparable.swift, 30.01.2022-12.02.2025.
...
private extension URL {
	...
	static func _lessThan(lhs: Self, rhs: Self) -> Bool {
		for result in [
	...
	static func compareComponents(lhs: Self, rhs: Self, using components: (Self) -> [String?]) -> ComparisonResult {
