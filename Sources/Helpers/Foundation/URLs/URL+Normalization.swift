// URL+Normalization.swift, 14.04.2024-29.01.2025.
...
public extension URL {
	...
	///
	/// See [URL Normalization](<doc:URLNormalization#Normalization>) for more information.
	func normalized(
	...
	/// If the URL is malformed, `nil` is returned.
	///
	/// See [URL Normalization](<doc:URLNormalization#Lexical-Normalization>) for more information.
