...
private extension URL {
	...
	@discardableResult func assertRelativized(
		...
		assert(expectedBaseString != baseString, "Remove redundant `expectedBaseString` parameter.", file: #file, line: UInt(sourceLocation.line))
	...
	@discardableResult func assertRelativized(
		...
		assert(expectedBasePath != basePath, "Remove redundant `expectedBasePath` parameter.", file: #file, line: UInt(sourceLocation.line))
