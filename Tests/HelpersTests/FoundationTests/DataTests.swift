// DataTests.swift, 29.12.2024-03.01.2025.
...
private extension Data {
	@discardableResult func assertCount(_ expected: Int, sourceLocation: SourceLocation = #_sourceLocation) -> Self {
		let result = count
		#expect(result == expected, sourceLocation: sourceLocation)
		return self
	}

	@discardableResult func assertNonzeroBits(_ expected: [Int], sourceLocation: SourceLocation = #_sourceLocation) -> Self {
