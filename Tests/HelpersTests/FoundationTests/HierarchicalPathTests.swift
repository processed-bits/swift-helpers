// HierarchicalPathTests.swift, 18.01.2025-23.01.2025.
...
private extension HierarchicalPath {
	...
	@discardableResult static func assertString(_ string: String, sourceLocation: SourceLocation = #_sourceLocation) throws -> Self {
	...
	@discardableResult func assertLexicallyNormalized(_ string: String, sourceLocation: SourceLocation = #_sourceLocation) throws -> Self {
		var path = self
	...
	@discardableResult func assertRemovedEmptyComponents(_ string: String, sourceLocation: SourceLocation = #_sourceLocation) throws -> Self {
		var path = self
