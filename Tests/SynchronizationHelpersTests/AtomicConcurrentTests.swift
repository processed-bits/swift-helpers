// AtomicConcurrentTests.swift, 10.03.2025.
// Copyright © 2025 Stanislav Lomachinskiy.
	...
	@Suite(.tags(.concurrency)) struct AtomicConcurrentTests: ConcurrencyTest {

		typealias Wrapper = AtomicConcurrent
		let typeDescription = "AtomicConcurrent"
