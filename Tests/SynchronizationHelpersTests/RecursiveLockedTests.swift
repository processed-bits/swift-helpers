// RecursiveLockedTests.swift, 10.03.2025.
// Copyright © 2025 Stanislav Lomachinskiy.
	...
	@Suite(.tags(.concurrency)) struct RecursiveLockedTests: ConcurrencyTest {

		typealias Wrapper = RecursiveLocked
		let typeDescription = "RecursiveLocked"
